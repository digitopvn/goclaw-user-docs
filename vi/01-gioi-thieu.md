...
│  Anthropic  OpenAI  ...   │  │  fs  exec  web  memory  MCP    │
│  20+ providers supported  │  │  teams  browser  TTS  media    │
└───────────────────────────┘  └────────────────────────────────┘
                         │
┌────────────────────────▼────────────────────────────────────┐
│                     STORE LAYER                              │
...
Sau khi nắm được tổng quan, đọc tiếp:

- [02-cai-dat-va-khoi-dong.md](./02-cai-dat-va-khoi-dong.md) — Cài đặt và khởi động GoClaw (Standard + Lite)
