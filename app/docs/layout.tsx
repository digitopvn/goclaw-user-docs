      ...
      nav={{
        ...
        children: (
          <div className="flex items-center gap-2">
            {/* Language toggle */}
            <Link href="/docs" className="px-2 py-1 text-xs font-semibold rounded bg-fd-primary text-fd-primary-foreground">
              VI
            </Link>
            <Link href="/en/docs" className="px-2 py-1 text-xs font-semibold rounded hover:bg-fd-accent transition-colors">
              EN
            </Link>
            {/* Home */}
