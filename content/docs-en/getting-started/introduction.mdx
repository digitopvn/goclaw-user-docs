...
description: Overview of GoClaw — an AI agent gateway for multi-tenant LLM orchestration
---
...
- Enhanced security (5-layer defense, AES-256-GCM encryption)
...
- **Knowledge graph** — LLM extraction and traversal
...
**Lite** is designed for personal use on your own computer — no server or separate database required.

**Standard** is for production deployments: serving multiple users and tenants, with real messaging channel integrations.
...
| Node.js | Optional — required for MCP servers via stdio |
...
- [Installation & Setup](/en/docs/getting-started/installation) — Install and start GoClaw (Standard + Lite)
